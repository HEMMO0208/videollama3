...
SPLIT="${SPLIT:-mini}"
JSONL_PATH="${JSONL_PATH:-data/tvbench/${SPLIT}_sft.jsonl}"
DATA_FOLDER="${DATA_FOLDER:-/home/hmkang/project/videollama3/TVBench/video}"
OUTPUT_DIR="${OUTPUT_DIR:-results/tvbench}"
...
"$PYTHON_BIN" scripts/tvbench/infer_tvbench_jsonl.py \
