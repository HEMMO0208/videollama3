...
ARG_MASTER_PORT=${MASTER_PORT:-16671}
ARG_RANK=${RANK:-0}
...
DATA_PATH=${DATA_PATH:-data/nextqa_oe/train_sft.jsonl}
OUTPUT_DIR=${OUTPUT_DIR:-work_dirs/nextqa_oe_causal_diffusion}
RUN_NAME=${RUN_NAME:-nextqa_oe_causal_diffusion}
